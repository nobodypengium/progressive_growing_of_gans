...
#env.CUDA_VISIBLE_DEVICES                       = '0'       # Unspecified (default) = Use all available GPUs. List of ints = CUDA device numbers to use. TODO:改GPU数量
env.TF_CPP_MIN_LOG_LEVEL                        = '0'       # 0 (default) = Print all available debug info from TensorFlow. 1 = Print warnings and errors, but disable debug info. TODO:更改打印数量
...
grid        = EasyDict(size='1080p', layout='random')       # Options for train.setup_snapshot_image_grid(). TODO:更改大小
...
# Config presets (choose one). TODO:此处配置含义? 参见train.py
...
# Numerical precision (choose one). TODO:FP16更快？
# desc += '-fp32'; sched.max_minibatch_per_gpu = {256: 16, 512: 8, 1024: 4}
desc += '-fp16'; G.dtype = 'float16'; D.dtype = 'float16'; G.pixelnorm_epsilon=1e-4; G_opt.use_loss_scaling = True; D_opt.use_loss_scaling = True; sched.max_minibatch_per_gpu = {512: 16, 1024: 8}

# Disable individual features. TODO:关注G的一些配置，究竟是调用了TF的哪些代码推知作用
...
# desc += '-HIST'; train.save_weight_histograms = True #TODO:什么形式保存weight
